...
- A Codex CLI login for Codex limits, a Claude web login in Google Chrome for Claude limits, and local CLI transcripts for history.
...
| `npx electron scripts/verify-claude-web-electron.js` | Run the Chrome page collector in actual Chromium using an offline Electron fixture; all HTTPS responses are local fixtures. This does not test native Chrome Apple Events. |
...
| Claude Chrome integration, account binding, or usage parsing | `claude-web-usage.js` |
