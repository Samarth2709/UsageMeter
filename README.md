...
Prerequisites: macOS and Node.js 20 or newer. Codex limits require its CLI login; Claude limits require a Claude web login. Local history requires CLI transcripts.
